...
const detailRows = (transaction) => [
  ...
  { label: "Supplier", value: transaction?.supplier_name || "Not linked" },
  { label: "Unit", value: transaction?.unit_symbol || "Not specified" },
  { label: "User", value: transaction?.user_name || "Not linked" },
